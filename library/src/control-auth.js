...
export function controlKeys (dataDir) {
  ...
  // control server starts, so an operator is locked out of a running library. Written once;
  // whole or absent (absent simply mints a fresh pair and invalidates live tokens).

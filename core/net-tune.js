...
//
// NOT re-exported from index.js on purpose: this module reads /proc and is server-side
// only, while index.js is bundled into the Bare worklet. Import it by path:

...
| `HLS_LIST_SIZE` | `8` | Rolling playlist window, in segments. Use `12` (24 s at `HLS_TIME=2`) as the standard setting: it gives the viewer apps' ~10 s live offset a comfortable margin, and large swarms more blocks to share. |

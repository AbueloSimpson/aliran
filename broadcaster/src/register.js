// Broadcaster → panel stream registration (authenticated with the publisher key).
//
// The broadcaster signs hash(challenge || payload) with the Ed25519 publisher secret;

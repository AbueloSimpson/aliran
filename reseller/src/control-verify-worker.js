// Argon2id verification for principal logins, off the main thread.
//
...
// event loop for the whole grind: control API, sweeps, everything. On a
// swapping small host that grind is minutes per verify (2026-07-16
// login-flood incident: 4-5 POSTs = 25+ min outage). This worker keeps the
// loop free; makePrincipalVerifier (control-auth.js) owns the single-flight +
